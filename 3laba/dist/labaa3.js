...
const owner = new OwnerClass('Сидорова', 'Анна', 'Олеговна', new Date(2000, 3, 13), DocumentType.Passport, 'AB', '123456');
const vehicle = new VehicleClass('Toyota', 'Camry', 2020, 'JTM1234567890ABCDE', 'A123BC', owner);
